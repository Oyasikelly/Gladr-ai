...
export default function GladrApp() {
	return (
		<section className="relative lg:px-40 py-8 md:py-15 h-auto text-center flex flex-col items-center">
			<div className="relative bg-[#4319BC] grid grid-cols-1 md:grid-cols-2 justify-center items-center w-[90%] lg:w-full pt-6 rounded-xl mx-1 md:mx-0 shadow-[2rem_-2rem_0_#B884FC]">
				{/* Background Zigzag Overlay */}
				...
				{/* Animated Left Section (Text + Buttons) */}
				<AnimatedGladrCard index={0}>
					<div className="w-full lg:w-[500px] relative z-20">
						...
						<div className="flex items-center gap-4 w-fit py-2 px-4 rounded-full mt-4">
							<div>
								<img
				...
				{/* Animated Right Section (Phone Image) */}
				<AnimatedGladrCard index={1}>
